...
Copy config to the expected location (from this repo):
...
For programming, Norwegian **no-dead-keys** is useful.
...
On **Wayland**:
Set input source/layout variant in your desktop/compositor keyboard settings
(e.g. “Norwegian (no dead keys)”).
